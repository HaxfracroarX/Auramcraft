...
public class AumwoodWorldGenTree extends WorldGenAbstractTree
{
    ...
    public AumwoodWorldGenTree(boolean p_i45449_1_, boolean p_i45449_2_)
    {
        super(p_i45449_1_);
    ...
    public boolean generate(World par1World, Random par2Random, int par3, int par4, int par5)
    {
        ...
        if (par4 >= 1 && par4 + l + 1 <= 256)
        {
            ...
            else
            {
                ...
                boolean isSoil = block2.canSustainPlant(par1World, par3, par4 - 1, par5, ForgeDirection.UP, (BlockSapling)AuramcraftBlocks.aumwoodSapling);
                if (isSoil && par4 < 256 - l - 1)
                {
                        ...
                        for (int l2 = par3 - k1; l2 <= par3 + k1; ++l2)
                        {
                            ...
                            for (int i2 = par5 - k1; i2 <= par5 + k1; ++i2)
                            {
                                ...
                                if (Math.abs(l1) != k1 || Math.abs(j2) != k1 || par2Random.nextInt(2) != 0 && j1 != 0)
                                {
                                    ...
                                    {
                                        this.setBlockAndNotifyAdequately(par1World, l2, k2, i2, AuramcraftBlocks.aumWoodLeaves, 2);
                                    }
                                }
                            }
                        }
                    ...
                    for (k2 = 0; k2 < l; ++k2)
                    {
                        ...
                        {
                            this.setBlockAndNotifyAdequately(par1World, par3, par4 + k2, par5, AuramcraftBlocks.aumWood, 2);
                        }
                    }
