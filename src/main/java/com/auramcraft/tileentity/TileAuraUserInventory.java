...
public class TileAuraUserInventory extends TileInventory implements IAuraUser {
	private AuraContainer container;
	
	public TileAuraUserInventory(String name, Block block, int slots, AuraContainer container) {
